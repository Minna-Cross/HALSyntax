...
class KnucklebonesGame:
    ...
    def display_grids_with_scores(self):
        ...
        print('\t'.join([str(score) for score in player2_column_scores]) + f"\t\t= {total_player2_score}\n")
        ...
        print('\t'.join([str(score) for score in player1_column_scores]) + f"\t\t= {total_player1_score}")
